      SUBROUTINE Xabclib_EVAL (N,NNZ,IRP,ICOL,VAL,X,B,RI,RERR,INFO)
...
*  =======
*
*  Xabclib_GMRES_EVAL estimates the error of the approximate solution 
...
*  beta = || b - A x_i ||_2
*
      CALL OpenATI_DURMV_11(N,NNZ,IRP,ICOL,VAL,X,RI)
      DO I=1,N
         RI(I)=RI(I)-B(I)
      END DO
      BETA=0.0D0
